...
def transform_all(clients_raw: pd.DataFrame,
                  policies_raw: pd.DataFrame,
                  vehicles_raw: pd.DataFrame,
                  claims_raw: pd.DataFrame) -> Dict[str, Any]:
    ...
    ml_fraud, ml_severity = build_ml_claim_dataset(clean_clients, clean_policies, clean_vehicles, clean_claims)
    ...
    return {
        ...
        "ml_claim_fraud": ml_fraud,
        "ml_claim_severity": ml_severity,
    }
